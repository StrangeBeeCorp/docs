...
* Sources: [https://github.com/StrangeBeeCorp/integrations](https://github.com/StrangeBeeCorp/integrations)
* Documentation:
...
If you'd like to contribute and share your templates with TheHive users community, feel free to create a [pull request on the GitHub repository](https://github.com/StrangeBeeCorp/integrations/pulls).
