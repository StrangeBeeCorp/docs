Enter the JavaScript code for your function. If you need inspiration, check out the [GitHub repository with function examples](https://github.com/StrangeBeeCorp/integrations/tree/main/.generated/docs/functions){target=_blank}.
