    ...
    3. Install the package.
        ...
        * Using `dpkg`:
            ...
            !!! tip "Missing dependencies"
                You might encounter warnings about missing dependencies during installation. To resolve this, run the commands described in the [Required packages section of the installation guide](/cortex/installation-and-configuration/step-by-step-guide/).
