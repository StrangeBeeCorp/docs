!!! info "Service commands"
    ...
    * Package installation: Depending on your distribution and the service, use `systemctl` or `service`. See the [systemctl documentation](https://www.man7.org/linux/man-pages/man1/systemctl.1.html){target=_blank} and the service documentation for details.
