=== "DEB"
    ...
    1. Download the installation package along with its SHA256 checksum and signature files.
        ...
        * Using `wget`:
            ...
            * Replace `<file_name>` with the full name of the versioned file you want to install. For example, use `thehive_5.6.5-1_all`. 
...
=== "RPM"
    ...
    1. Download the installation package along with its SHA256 checksum and signature files.
        ...
        * Using `wget`:
            ...
            * Replace `<file_name>` with the full name of the versioned file you want to install. For example, use `thehive-5.6.5-1`.
            * Replace `<major.minor_version>` with the corresponding version directory. For example, use `5.6`.
    ...
    2. Install the package.
        ...
        * Using `rpm`:
            ...
            ```bash
            sudo rpm -Uvh /tmp/thehive-{% include-markdown "includes/thehive-latest-version.md" start="<!--start-fullversion-->" end="<!--end-fullversion-->" %}-1.noarch.rpm
            ```