...
### Step 1: Create a New Power Automate Flow
  ...
  1. **Navigate to Power Automate**:
    ...
    - Go to [Power Automate](https://make.powerautomate.com/) and sign in with your Microsoft account.
      ...
      ![](/thehive/images/user-guides/organisation/notifications/msteams-1.png)
  ...
  3. **Select Template**:
    ...
    - Choose the template **"Post to a channel when a HTTP request is received"**.
      ...
      ![](/thehive/images/user-guides/organisation/notifications/msteams-2.png)
  ...
  4. **Configure Flow Details**:
    ...
    - Confirm the necessary permissions for Power Automate to post messages on your behalf.
      ...
      ![](/thehive/images/user-guides/organisation/notifications/msteams-3.png)
...
<figure markdown>
  ![Endpoints list](/thehive/images/user-guides/organisation/notifications/organisation-endpoints.png)
</figure>
...
<figure markdown>
  ![Teams endpoint configuration](/thehive/images/user-guides/organisation/notifications/organisation-endpoints-teams-configuration.png)
</figure>
...
<figure markdown>
  ![Choose Teams](/thehive/images/user-guides/organisation/notifications/organisation-notifications-teams-1.png)
</figure>
...
<figure markdown>
  ![MS Teams card](/thehive/images/user-guides/organisation/notifications/organisation-notifications-teams-2.png)
</figure>
...
1. Set Up Microsoft Teams:
    ...
    - Follow the video tutorial to create an incoming webhook and copy the provided URL
      ...
      <video controls>
        <source id=mp4 src="/thehive/images/user-guides/organisation/notifications/organisation-endpoints-msteams-configuration.mp4" type="video/mp4">
      </video>
