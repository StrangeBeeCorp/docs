...
* [Alerts](../cases/create-a-new-case.md#create-a-case-from-an-alert): Convert security alerts generated by detection tools (SIEM, EDR, IDS, etc.) into cases for further investigation.
