...
* [Alerts](../cases/create-a-new-case.md#create-a-case-from-an-alert): Convert security alerts generated by detection tools (SIEM, EDR, IDS, or firewalls) or an [email intake connector](../../../administration/email-intake-connector.md) into cases for further investigation.
