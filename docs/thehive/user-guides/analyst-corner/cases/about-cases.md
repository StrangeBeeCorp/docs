...
!!! warning "Audit logs behavior"
    The behavior of [audit logs](../../organization/about-audit-logs.md) when visibility is restricted on a case depends on the database technology you're using:  
