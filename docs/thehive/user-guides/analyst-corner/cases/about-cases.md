...
You can [restrict visibility](./case-visibility/restrict-visibility-case.md) to a specific group of users to secure sensitive cases and later [restore visibility](./case-visibility/restore-visibility-case.md) if needed. 
