...
This topic provides step-by-step instructions for changing the classification settings of a case or alert in TheHive, including severity, Traffic Light Protocol (TLP), and Permissible Actions Protocol (PAP).
