...
!!! tip "Why can't I find a case?"
    Since TheHive 5.5, [case visibility](../../cases/about-cases.md#visibility) can be restricted to protect sensitive data. If a case has restricted visibility and you are not an authorized user, it will not appear in the case list, search results, or dashboards.
