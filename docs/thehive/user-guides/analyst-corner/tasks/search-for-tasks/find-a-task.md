...
!!! note "Refine results"
    The search bar searches across all element types—cases, alerts, observables, tasks, task logs, jobs, <!-- md:version 5.8 --> comments, and <!-- md:version 5.8 --> pages—but it doesn't support filters.
