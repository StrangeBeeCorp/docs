...
An alert is automatically linked to a case when you [merge it into a new case](merge-an-alert-into-a-new-case.md) or [merge it into an existing one](merge-an-alert-into-an-existing-case.md).
