...
An alert is automatically linked to a case when you [merge it into a new case](../cases/create-a-new-case.md#create-a-case-from-an-alert) or [merge it into an existing one](merge-an-alert-into-an-existing-case.md).
