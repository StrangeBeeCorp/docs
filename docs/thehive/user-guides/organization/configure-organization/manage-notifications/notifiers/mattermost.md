...
Configure the *Mattermost* [notifier](../about-notifications.md#notifiers) in TheHive.
...
1. When [creating a new notification](../create-a-notification.md) or editing an existing one, select the **Mattermost** notifier.
