...
* [Custom events](../../../../analyst-corner/cases/cases-description/case-timelines/add-custom-event-timeline.md). <!-- md:version 5.5 --> You can choose if you want to display custom events with or without their descriptions.
