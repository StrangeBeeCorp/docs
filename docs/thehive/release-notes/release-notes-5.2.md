...
!!! warning "Unmaintained version"
    Version 5.2 is no longer maintained and won't receive further fixes, including security fixes. Upgrade to a maintained version as soon as possible. See the [release and maintenance policy](../installation/release-and-maintenance-policy.md) for details. Contact StrangeBee Support for upgrade assistance.
