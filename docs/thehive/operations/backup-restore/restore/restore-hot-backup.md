...
1. Restore a saved Elasticsearch index ; follow Elasticsearch guides to perform this action
...
!!! Warning "Once TheHive application is started, both lines should be removed or commented from the _application.conf_ configuration file"
