...
=== "Linux installation"
    ...
    |-----------------|------|-----------|---------------|------------|-------|-------|
    | 5.5.10+ | 11 | 4.0.x - 4.1.x | 7.11.x - 9.1.x | Supported, except for audit log storage | 3.1.6+ | ES 7.17+ required for [audit log storage](installation-guide-linux-standalone-server.md#step-53-audit-log-storage) |
    | 5.5.0 - 5.5.9 | 11 | 4.0.x - 4.1.x  | 7.11.x - 8.x | Supported, except for audit log storage | 3.1.6+ | ES 7.17+ required for [audit log storage](installation-guide-linux-standalone-server.md#step-53-audit-log-storage) |
    | 5.3.0 - 5.4.11 | 11 | 4.0.x - 4.1.x  | 7.10.x - 8.x | Supported | All versions | --- |
